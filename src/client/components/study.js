export default function () {
    ...
    let studyText = [{
        id: 'study1', title: 'Макияж для себя. Включаем мозги!', text: `Курс для тех, кто хочет подходить к ежедневному макияжу с умом!<br>
    ...
    {
        id: 'study2', title: 'Интенсив-курс «Локоны»', text: `Как правильно подготовить волосы, про средства для укладки и инструменты!<br>
        Интенсив-курс разработан для мастеров разного уровня подготовки (новички, работающие мастера).<br>Стоимость курса 4000 (2 дня). Группы 3-4 человека<br><br>
        ...
        Показ+ отработка<br><br>Максимум внимания каждому (мини-группа). По окончанию обучения выдаётся сертификат. Помощь в поиске моделей`},
    {
    ...
    {
        id: 'study4', title: 'Стилист', text: `Долгожданный авторский курс "Стилист"! Красивая творческая профессия с нуля!<br>17 показов, 13 практик по современным
        макияжам и самым востребованным коммерческим прическам (отработки на моделях), МК от наших лучших стилистов и партнеров по обработке фото и продвижению,
        ведение социальных сетей. Фото и видео учебного процесса, творческая фотосессия.<br><br>Курс разработан специально для работы стилистом! Максимум практики и теории.
        Выдается сертификат.<br><br>Следите за новостями, подробности и дата начала курса ближайшее время. Запись уже сейчас!` },
    {
        id: 'study5', title: 'Современная коммерческая прическа. Тренды 2019 года', text: `Для начинающих мастеров и работающих стилистов с опытом.<br>6 востребованных
        коммерческих причесок актуальных в новом сезоне (показы и отработки). Текстура, структура, новые техники и легкость в прическах. Формы в прическах, плетения,
    ...
    {
        id: 'study6', title: 'Мастер классы', text: `МК по макияжу, работе с волосами, продвижению и др. от наших стилистов и партнеров.<br>
